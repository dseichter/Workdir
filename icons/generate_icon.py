...
def generate_ico():
    ...
    logo_file = "folder_open_48dp_8B1A10_FILL0_wght400_GRAD0_opsz48.png"
    if os.path.exists(logo_file):
        with Image.open(logo_file) as img:
            # Save as ICO with multiple sizes
            img.save("workdir.ico", format="ICO", sizes=[(16,16), (32,32), (48,48), (64,64), (128,128), (256,256)])
            print("✓ Generated workdir.ico")
    else:
