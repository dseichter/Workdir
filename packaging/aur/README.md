...
The `PKGBUILD` in this directory defines the Arch Linux User Repository (AUR) package for Workdir.
...
SHA256=$(curl -fsSL "https://github.com/dseichter/Workdir/archive/refs/tags/v${PKGVER//./-}.tar.gz" | sha256sum | cut -d' ' -f1)
